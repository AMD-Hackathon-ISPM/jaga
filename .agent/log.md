...
- 2026-06-28 — Added `backend/python/project` as an independent, embedding-first TB-CXR research scaffold with interchangeable backbones, training/eval pipelines, and embedding export; added a thin `backend/go` service scaffold; documented it as a stretch CXR track that does not alter the cough+clinical MVP invariant. (Codex)
