...
| **Render an illustrative detected-cough summary from the local recording**                                                              | The result figure derives waveform bars and an orange energy ramp from the decoded recording and heuristic event times. It is labelled “Detected cough moments” and “Illustrative recording summary, not model output”; the orange ramp is distinct from the unchanged risk-band ramp and is never described as model focus.                                                                                                                                                                                                                                                            |
